                    ...
                    <ul>
                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="{{URL::to('/cau-hoi-thuong-gap')}}"
                                        title="Câu hỏi thường gặp">Câu hỏi thường
                                        gặp</a></li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <div class="detail-static">
                        ...
                        <ul>
                            <li>Siêu Thị Nhật Bản Japana&nbsp;là website bán hàng Nhật Bản, các sản phẩm do văn phòng
                                đại diện
                                tại Nhật Bản hoặc do các Nhà cung cấp nhập khẩu trực tiếp từ Nhật Bản về Việt Nam. Theo
                                quy định
                                hiện hành của Siêu Thị Nhật Bản Japana, một số sản phẩm sau khi khách hàng đặt mua chúng
                                tôi mới
                                nhập về.</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>100% sản phẩm của Japana đều phải thông qua bộ phận kiểm tra chất lượng KCS, chất lượng
                                sản phẩm
                                đầu vào được kiểm soát và đạt chuẩn mới được thông qua và bán tại
                        ...
                        <ul>
                            ...
                            <li>Japana là trang thương mại điện tử duy nhất tại Việt Nam 100% sản phẩm phải thông qua bộ
                                phận
                                KCS kiểm tra chất lượng đầu vào, đạt chuẩn mới được giao cho khách hàng nên giá bán phù
                                hợp với
                        ...
                        <p>Kể từ thời gian nhận hàng, Quý khách có quyền từ chối nhận hàng và thực hiện đổi/trả hàng
                            theo điều
                            kiện đổi/trả hàng được cụ thể bên dưới. Quý khách hãy liên hệ ngay với bộ phận Chăm sóc
                            khách hàng
                        ...
                        <ul>
                            <li>Các dòng thực phẩm là Thực phẩm chức năng không phải là thuốc nên không có chống chỉ
                                định. Tuy
                                nhiên, tùy thuộc vào từng sản phẩm chúng tôi có những khuyến cáo riêng, vui lòng đọc kĩ
                                hướng
                        ...
                        <ul>
                            <li>Thông tin trọng lượng của sản phẩm trên website là trọng lượng tương đối, chỉ mang tính
                                chất
                                tham khảo để giúp khách hàng hình dung rõ hơn về sản phẩm. KHÔNG có ý nghĩa cho việc
                                kiểm tra
                        ...
                        <h3><strong>6. Các sản phẩm giảm cân thông thường hay chống chỉ định cho những người bị bệnh
                                huyết áp,
                                tim mạch, tiểu đường. Tôi bị huyết áp cao, có thể sử dụng sản phẩm giảm cân của Siêu Thị
                                Nhật
                        ...
                        <ul>
                            <li>Đối với người cơ địa hấp thụ tốt có thể thấy cơ thể mập lên nhưng chỉ là tạm thời. Trong
                                quá
                                trình sử dụng collagen, khách hàng nên uống nhiều nước để giúp cơ thể thanh lọc cơ thể
                                và tăng
                        ...
                        <ul>
                            <li>Đông trùng hạ thảo và nấm Linh chi đều có tác dụng tốt đối với sức khỏe tim mạch và
                                huyết áp,
                                quý khách hàng có thể kết hợp cả hai sản phẩm để giúp điều hòa huyết áp và giảm
                                cholesterol một
                        ...
                        <ul>
                            ...
                            <li>Ngừng sử dụng sản phẩm trong khoảng 3 - 5 ngày, sau đó bôi lại một lớp thật mỏng ở phần
                                nhỏ của
                                mặt hay mặt trong cánh tay để xem phản ứng của làn da, nếu bình thường có thể tiếp tục
                                sử dụng.
                            </li>
                        ...
                        <ul>
                            <li>Các dòng Thực phẩm chức năng của Nhật Bản có nguồn gốc từ thiên nhiên nên an toàn và
                                lành tính
                                với người sử dụng. Một số dòng sản phẩm sẽ có biểu hiện theo lưu ý của Nhà sản xuất, đó
                                là biểu
                        ...
                        <ul>
                            <li>Các bác sĩ khuyến cáo người bị u xơ tử cung tránh dùng Estrogen liều cao và kéo dài vì
                                dễ ảnh
                                hưởng đến sự phát triển của u xơ tử cung. Còn việc sử dụng các sản phẩm collagen thì
                                không gây
                                ảnh hưởng gì.</li>
                        ...
                        <ul>
                            <li>Để mua mỹ phẩm SK-II chính hãng nên lựa chọn địa chỉ bán hàng uy tín, chất lượng. Ngoài
                                ra, bạn
                                có thể truy cập các website uy tín để kiểm tra xuất xứ, hạn sử dụng và thông tin sản
                                phẩm.</li>
                        </ul>
                        ...
                        <p><iframe height="480"
                                src="https://www.google.com/maps/d/embed?mid=1rZRxioJd4yWbwdtOMmX2_PsmjqYArtC7"
