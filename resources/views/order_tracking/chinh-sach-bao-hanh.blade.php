                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li><a href="{{URL::to('/thoi-gian-giao-hang')}}" title="Thời gian giao hàng">Thời gian
                                        giao
                                        hàng</a></li>
                                <li class="active"><a href="{{URL::to('/chinh-sach-bao-hanh')}}"
                                        title="Chính sách bảo hành">Chính sách bảo
                                        hành</a></li>
        ...
        <div class="col-lg-8 col-xl-9">
            <div class="static-detail">
                ...
                <div class="detail-static">
                    ...
                    <p style="text-align:justify">- Phiếu bảo hành đầy đủ thông tin: kiểu máy, số seri, ngày sản xuất,
                        tên
                        khách hàng sử dụng, địa chỉ, ngày mua (đối với các sản phẩm không áp dụng Bảo hành điện tử)</p>

                    <p style="text-align:justify">- Tem bảo hành (và tem niêm phong) của nhà sản xuất trên sản phẩm còn
                        nguyên vẹn.</p>

                    <p style="text-align:justify">2. Những trường hợp không được bảo hành hoặc phát sinh phí bảo hành:
                    </p>
                    ...
                    <p style="text-align:justify">- Vi phạm một trong những điều kiện bảo hành miễn phí ở mục 1.<br>
                        ...
                        - Khách hàng tự ý can thiệp sửa chữa sản phẩm hoặc sửa chữa tại những trung tâm bảo hành không
                        được
                        sự ủy nhiệm của Hãng.<br>
                    ...
                    <p style="text-align:justify">Thời hạn bảo hành được tính kể từ ngày mua hàng hoặc kể từ ngày sản
                        xuất
                        tùy thuộc từng loại sản phẩm được quy định rõ trên phiếu bảo hành. Đối với sản phẩm bảo hành
                        điện
                        tử, thời hạn bảo hành được tính từ thời điểm kích hoạt bảo hành điện tử.</p>

                    <p style="text-align:justify"><strong>III. TRUNG TÂM BẢO HÀNH:</strong></p>

                    <p style="text-align:justify">Thông tin của trung tâm bảo hành sẽ được ghi trong phiếu bảo hành kèm
                        theo
                        sản phẩm. Quý khách vui lòng liên hệ trực tiếp với trung tâm bảo hành có trên phiếu bảo hành.
                    </p>

                    <p style="text-align:justify">Trong trường hợp sản phẩm được phân phối trực tiếp từ các Đại lý, quý
                        khách vui lòng trực tiếp liên hệ với đại lý đó để được hỗ trợ bảo hành trong thời gian nhanh
                        nhất.
                        Mọi thông tin của đại lý được ghi trên phiếu biên nhận giao hàng được đính kèm trong thùng hàng.
                    </p>

                    <p style="text-align:justify">Nếu quý khách gặp khó khăn trong việc liên hệ trung tâm bảo hành, xin
                        quý
                        khách vui lòng liên hệ bộ phận Chăm sóc khách hàng theo tổng đài&nbsp;<strong>(028)&nbsp;7108
                            8889</strong></p>

                    <p style="text-align:justify">Trong trường hợp quý khách ở quá xa trung tâm bảo hành hoặc gặp các
                        vấn đề
                        bất tiện không thể đến trung tâm bảo hành trực tiếp, quý khách có thể gửi sản phẩm về Japana.vn,
                        chúng tôi sẽ hỗ trợ gửi sản phẩm đi bảo hành giúp quý khách..</p>
                </div>
            </div>
        </div>
    </div>
