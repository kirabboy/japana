                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li><a href="{{URL::to('/chinh-sach-bao-mat')}}" title="Chính sách bảo mật">Chính sách
                                        bảo
                                        mật</a></li>
                                <li class="active"><a href="{{URL::to('/chinh-sach-doi-tra-va-hoan-tien')}}"
                ...
                <div class="static-detail">
                    ...
                    <div class="detail-static">
                        ...
                        <p>Hiểu được sự ngần ngại/lo lắng của khách hàng về tính xác thực của hàng hóa khi mua sắm trực
                            tuyến,
                            Siêu thị Nhật Bản Japana.vn hỗ trợ chính sách đồng kiểm, áp dụng với tất cả các sản phẩm
                            được bán
                            tại website Japana <strong>(Không áp dụng với các sản phẩm được niêm phong bởi nhà sản
                                xuất).</strong></p>

                        <p>Trước khi chấp nhận và thanh toán cho một đơn hàng, khách hàng của Japana có quyền yêu cầu
                            được mở
                            thùng hàng để kiểm tra hàng hóa bên trong có đúng với thông tin đặt hàng hay không. Các
                            thông tin
                            bao gồm: Số lượng, chủng loại (Model), màu sắc, kích thước, hình thức, tính nguyên vẹn của
                            hàng hóa.
                        </p>
                        ...
                        <p><strong>*** LƯU Ý: </strong>Thông tin trọng lượng của sản phẩm được thể hiện trên website là
                            trọng
                            lượng tương đối, chỉ mang ý nghĩa tham khảo (giúp khách hàng hình dung rõ hơn về sản phẩm),
                            không có
                            ý nghĩa cho việc kiểm tra, đổi trả lại hàng hóa.&nbsp;</p>
                        ...
                        <p style="text-align: center;"><img alt="CHÍNH SÁCH ĐỔI TRẢ VÀ HOÀN TIỀN"
                                src="{{URL::to('public/images/dieukiendoihang.png')}}"
                                style="width: 800px; height: 472px;"></p>

                        <p style="text-align: center;"><img alt="Chính sách đổi trả và hoàn tiền"
                                src="{{URL::to('public/images/dieukiendoihang2.png')}}"
                                style="width: 800px; height: 108px;"></p>
                        ...
                        <p style="text-align: center;"><img alt="CHÍNH SÁCH ĐỔI TRẢ VÀ HOÀN TIỀN"
                                src="{{URL::to('public/images/dieukientrahang.png')}}"
                        ...
                        <p><strong>- Bước 3: </strong>Sau khi yêu cầu đổi trả hàng được chấp thuận, quý khách vui lòng
                            đóng gói
                            cẩn thận và gửi qua đường bưu điện hoặc phương tiện vận chuyển khác về cho chúng tôi theo
                            địa chỉ:
                        </p>
                        ...
                        <p><strong>- Bước 4: </strong>Quý khách vui lòng đóng gói bao bì cẩn thận, tránh trầy xước, hỏng
                            bể,
                            bong tróc hay bám bẩn so với lúc xác nhận chấp thuận đổi trả lại hàng.</p>

                        <p><strong>* LƯU Ý: </strong>Nếu sản phẩm gửi trả về bị hỏng, bể, trầy xước, bong tróc, bám
                            bẩn,... có
                            thay đổi so với thời điểm xác nhận chấp thuận đổi trả lại hàng, chúng tôi có quyền từ chối
                            nhận đổi
                            trả.</p>
                        ...
                        <p>Ngay sau khi đơn hàng huỷ trả khách hàng gửi về được chúng tôi xác nhận, <strong>trong vòng
                                07 ngày
                                làm việc</strong>, Siêu thị Nhật Bản Japana.vn sẽ chuyển trả lại toàn bộ số tiền cho sản
                            phẩm/đơn hàng mà quý khách đã thanh toán.</p>
                    </div>
                </div>
            </div>
        </div>
