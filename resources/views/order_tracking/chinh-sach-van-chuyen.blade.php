...
<html lang="en">
  ...
  <div class="container">
        ...
        <ul>
            ...
            <li class="active">
                <a href="#" title="Chăm sóc khách hàng">
                    ...
                    <ul>
                    <li class="active"><a href="{{URL::to('/chinh-sach-van-chuyen')}}" title="Chính sách vận chuyển">Chính sách vận chuyển</a></li>
    ...
    <div class="static-detail">
        <p class="title">Chính sách vận chuyển</p>
        <div class="detail-static">
            <p>Nhằm mang đến trải nghiệm mua sắm tiện lợi, an toàn, Japana với chính sách vận chuyển và Freeship như sau:</p>
            <p>- Đối với hoá đơn&nbsp;<strong>trên 1.500.000đ&nbsp;</strong>phí vận chuyển sẽ hoàn toàn&nbsp;<strong>MIỄN PHÍ</strong>.&nbsp;</p>
            <p>- Đối với những hoá đơn&nbsp;<strong>dưới 1.500.000đ sẽ tính phí ship như sau:</strong></p>

        <ul>
            <li>Khu vực nhận hàng TP. HCM: <strong>20.000đ</strong></li>
            <li>Khu vực nhận hàng&nbsp;các tỉnh, thành phố khác: <strong>40.000đ</strong></li>
        </ul>
        ...
        <p>Chính sách miễn phí vận chuyển được áp dụng cho tất cả các tỉnh thành, huyện xã, trung tâm đến địa phương vùng sâu, trong trường hợp Quý khách hàng khi nhận hàng, hoặc khi thanh toán vẫn còn bị tính phí vận chuyển, vui lòng báo về cho <strong>Siêu Thị Nhật Bản Japana</strong>&nbsp;theo số Tổng đài : <strong>(028) 7108 8889</strong> để chúng tôi có thể hỗ trợ tối đa cho Quý khách hàng!</p>
