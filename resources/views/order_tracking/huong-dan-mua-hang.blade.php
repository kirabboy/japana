    ...
    <div class="container">
            ...
            <ul>
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="{{URL::to('/huong-dan-mua-hang')}}" title="Hướng dẫn mua hàng">Hướng dẫn mua
                                hàng</a></li>
        ...
        <div class="static-detail">
            ...
            <div class="detail-static">
                <p>Quý khách có thể đặt mua hàng trực tuyến tại&nbsp;website <a href="https://japana.vn">Japana.vn</a>
                    thông qua các bước đơn giản sau</p>
                ...
                <p>Khi đã tìm được sản phẩm mong muốn, quý khách vui lòng bấm vào hình hoặc tên sản phẩm để vào được
                ...
                <p>Trong giỏ hàng thể hiện đầy đủ thông tin số lượng sản phẩm và tổng giá trị tiền hàng. Quý khách vui
                    lòng kiểm tra đúng sản phẩm, số lượng và giá trị tiền hàng.&nbsp;</p>
                ...
                <p>Quý khách phải điền đầy đủ thông tin của người mua và nhận hàng, Chúng tôi&nbsp;cam kết sẽ giữ bí mật
                    thông tin cá nhân của quý khách.</p>

                <p>Trên cơ sở thông tin quý khách cung cấp, <strong>Siêu Thị Nhật Bản Japana.vn</strong> sẽ tiến hành
                    các thủ tục còn lại để giao hàng</p>

                <h3><strong>5. Phương thức thanh toán:</strong></h3>

                <p>Hiện tại&nbsp;<strong>Siêu Thị Nhật Bản Japana.vn</strong> có các&nbsp;hình thức thanh toán cho khách
                    hàng lực chọn:</p>
                ...
                <p>Nếu các thông tin trên đã chính xác, quý khách&nbsp;vui lòng&nbsp;bấm "Đặt&nbsp;Mua", hệ thống sẽ bắt
                    đầu tiến hành tạo đơn hàng dựa trên các thông tin quý khách đã đăng ký.</p>
                ...
                <p>Sau khi đơn hàng đã được xác nhận bằng email, bộ phận chăm sóc khách hàng của <strong>Siêu Thị Nhật
                        Bản Japana.vn&nbsp;</strong>sẽ gọi điện trực tiếp cho quý khách hàng thông qua số điện thoại mà
                    quý khách hàng đã cung cấp để xác nhận lại&nbsp;một lần nữa về đơn hàng.</p>
            </div>
        </div>
</body>
