    ...
    <div class="container">
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li><a href="{{URL::to('/dieu-khoan-giao-dich')}}" title="Điều khoản giao dịch">Điều khoản giao
                                dịch</a></li>
                        <li class="active"><a href="{{URL::to('/phuong-thuc-thanh-toan')}}" title="Phương thức thanh toán">Phương thức
                                thanh toán</a></li>
        ...
        <div class="static-detail">
            ...
            <div class="detail-static">
                <p>Nhằm mang đến Quý khách những trải nghiệm mua sắm trực tuyến tuyệt vời nhất&nbsp;tại Siêu thị Nhật
                    Bản&nbsp;Japana.vn, chúng tôi có các&nbsp;phương thức thanh toán để Quý khách dễ dàng lựa chọn:</p>
                ...
                <h3><strong>I. Thanh toán bằng tiền mặt khi nhận hàng (COD)​</strong></h3>
                <p>COD là viết tắt của Cash On Delivery, nghĩa là thanh toán khi nhận hàng. Với phương thức thanh toán
                    này, Quý khách trả tiền mặt cho nhân viên giao hàng ngay khi nhận được đơn hàng của mình. Chúng tôi
                    chấp nhận hình thức thanh toán khi nhận hàng (COD) cho tất cả các đơn hàng trên phạm vi toàn quốc.
                </p>
                <p><strong>**Lưu ý:</strong> Chỉ áp dụng cho đơn hàng có tổng giá trị nhỏ hơn 10 triệu đồng. Nếu đơn
                    hàng trên 10 triệu đồng, Quý khách hàng&nbsp;vui lòng chọn hình thức thanh toán khác.</p>
                <p>Đơn giản. An toàn. Không chút rắc rối mà lại an tâm tuyệt đối khi Quý khách hàng&nbsp;chọn thanh toán
                    COD.</p>
                <h3><strong>II. Thanh toán trực tiếp tại Văn phòng&nbsp;Công ty Japana Việt Nam</strong></h3>
                <p>Quý khách hàng&nbsp;có thể đến trực tiếp văn phòng Công Ty Cổ Phần&nbsp;Japana Việt Nam tại địa chỉ:
                    Số 76 đường Nguyễn Háo Vĩnh, Quận Tân Phú, Tp. HCM và gặp trực tiếp nhân viên thu ngân để thanh
                    toán.</p>
                ...
                <p>Tại trang web của&nbsp;<a href="https://japana.vn">Japana.vn</a>, sau khi Quý khách hàng tiến hành
                    chọn sản phẩm và chọn mua hàng, tại trang cung cấp&nbsp;thông tin giao hàng. Các tư vấn viên hỗ trợ
                    của&nbsp;Japana&nbsp;sẽ cung cấp cho quý khách số tài khoản của Japana.vn&nbsp;tại&nbsp;các Ngân
                    hàng mà&nbsp;<strong>Công Ty Cổ Phẩn Japana Việt Nam</strong>&nbsp;chấp nhận thanh toán, Quý khách
                    hàng&nbsp;có thể lựa&nbsp;chọn Ngân hàng phù hợp nhất với mình để tiến hành thanh toán cho đơn hàng
                    đã chọn.</p>
                <p><strong>** Lưu ý: </strong>Khi Quý khách hàng chọn Phương thức thanh toán qua Ngân hàng, Đễ tránh
                    nhầm lẫn do có nhiều đơn hàng,&nbsp;đề nghị Quý khách hàng&nbsp;ghi "Số Đơn Hàng" của đơn
                    hàng&nbsp;đã được chúng tôi cung cấp cho Quý khách hàng&nbsp;qua email xác nhận đơn hàng&nbsp;trong
                    nội dung thanh toán.</p>
                <p><strong>Thông tin Ngân hàng:</strong></p>
                <p><img alt="Kết quả hình ảnh cho vcb"
                        src="{{URL::to('public/images/vietcombank.jfif')}}">
                </p>
                <ul>
                ...
                <p>Quý khách hàng khi mua hàng tại Japana có thể lựa chọn phương thức thanh toán bằng Ví điện tử VNPAY.
                    Bạn chỉ cần quét mã QR và xác nhận số tiền, vậy là bạn đã hoàn thành thanh toán một cách đơn giản,
                    nhanh gọn.</p>
                <p>Quý khách hàng có bất cứ thắc mắc, vấn đề trong quá trình thanh toán&nbsp;vui lòng liên hệ Japana
                    theo số Tổng đài <strong>(028) 7108 8889,</strong> để chúng tôi có thể hỗ trợ tối đa cho Quý khách
                    hàng!</p>
                <p><em><strong>Chúc Quý khách có trải nghiệm mua sắm hàng Nhật thật tuyệt vời tại JAPANA!</strong></em>
                </p>
            </div>
        </div>
