                    ...
                    <ul>
                        <li>
                            <a href="#" title="Japana Việt Nam">
                                <img src="{{URL::to('public/images/icon2.png')}}" alt="Japana Việt Nam"
                                    class="img-order">
                        ...
                        <li class="active">
                            <a href="#" title="Chăm sóc khách hàng">
                                <img src="{{URL::to('public/images/icon2.png')}}" alt="Chăm sóc khách hàng"
                                    class="img-order">
                            ...
                            <ul>
                                ...
                                <li><a href="{{URL::to('/phuong-thuc-thanh-toan')}}"
                                        title="Phương thức thanh toán">Phương thức
                                        thanh toán</a></li>
                        ...
                        <li>
                            <a href="{{URL::to('/lien-he')}}" title="Liên hệ">
                                ...
                                <img src="{{URL::to('public/images/icon2a.png')}}" alt="Liên hệ"
                                    class="hover-order">Liên hệ
                            </a>
                        </li>
                    </ul>
                </aside>
                ...
                <div class="static-detail">
                    ...
                    <div class="detail-static">
                        ...
                        <p>Chúng tôi là Công ty Cổ phần&nbsp;JAPANA Việt Nam, địa chỉ trụ sở chính tại Số 76&nbsp;Nguyễn
                            Háo
                            Vĩnh, Quận Tân Phú, TP.HCM và văn phòng&nbsp;Nhật Bản tại địa chỉ :&nbsp;Kangawa Ken Ebina -
                            Sbi
                            Nakana, Japan,&nbsp;hoạt động kinh doanh thương mại điện tử qua trang web của Siêu Thị Nhật
                            Bản
                        ...
                        <p><strong>Siêu thị Nhật Bản&nbsp;Japana</strong>&nbsp;ra đời mang một hoài bão khát khao tạo
                            nên bước
                            đột phá lớn trong lĩnh vực thương mại điện tử có kiểm soát chất lượng sản phẩm ở Việt Nam,
                            hướng đến
                        ...
                        <p>Với ý nghĩa trên, chúng tôi rất mong muốn hợp tác và chỉ hợp tác với các đối tác là các Công
                            ty, Cá
                            nhân, Nhà nhập khẩu, … muốn phân phối các sản phẩm uy tín, chất lượng đến với người tiêu
                            dùng Việt
                            Nam. Trong trường hợp Nhà cung cấp nào cung cấp cho chúng tôi các sản phẩm không
                            rõ&nbsp;nguồn gốc,
                            không đúng cam kết, không đảm bảo chất lượng, hàng giả, hàng nhái… gây thiệt hại cho quyền
                            lợi người
                            tiêu dùng, làm ảnh hưởng uy tín của chúng tôi đối với khách hàng thì Quý nhà cung cấp đó
                            hoàn toàn
                        ...
                        <p><strong>Khi Quý nhà cung cấp và/hoặc cho phép chúng tôi đưa hình ảnh sản phẩm của mình lên
                                website
                                japana.vn của chúng tôi có nghĩa là quý khách đồng ý với các điều khoản này.</strong>
                        </p>
                        ...
                        <ul>
                            ...
                            <li><strong>Bằng văn bản:</strong> bao gồm các hình thức thư xác nhận việc nhận được, thư
                                được gửi
                                trực tiếp hoặc gửi fax hoặc báo cáo trả lời từ máy fax, tin nhắn qua các phương tiện
                                mạng xã hội
                                khác như zalo, viber, facebook,… hoặc thư điện tử có xác nhận gửi đến địa chỉ email đăng
                                ký của
                                bên B.</li>
                            <li><strong>Thông tin hàng hóa và nội dung:</strong> bao gồm nhưng không giới hạn các thông
                                tin sau:
                                tên, tính năng, chất lượng, số lượng, xuất xứ, giá bán, thông số kỹ thuật, bảo hành,
                                vận&nbsp;
                            ...
                            <li><strong>Thông tin pháp lý:</strong> bao gồm nhưng không giới hạn tên, địa chỉ, người đại
                                diện
                                thông tin về các loại giấy phép theo quy định của pháp luật và các thông tin khác của
                                bên B.
                            </li>
                        ...
                        <ul>
                            ...
                            <li>Hàng hóa đăng tải trên Gian hàng thuộc quyền sở hữu hợp pháp của bên B. Hàng hóa không
                                thuộc
                                danh mục hàng hóa cấm quảng cáo, cấm kinh doanh và cấm đăng tải trên website japana.vn.
                                Đối với
                                hàng hóa thuộc danh mục kinh doanh có điều kiện thì bên B phải đảm bảo có đầy đủ điều
                                kiện theo
                                quy định của pháp luật khi kinh doanh hàng hóa này và cung cấp các giấy phép này ngay
                                khi có yêu
                                cầu của bên A. Nếu cung cấp sai, bên B chịu trách nhiệm với cơ quan chức năng theo quy
                                định.
                            </li>
                            ...
                            <li>Chuẩn bị sẵn hàng hóa và các giấy tờ kèm theo để chuyển cho khách hàng, như: Phiếu bảo
                                hành của
                                hàng hóa nếu có; phiếu hướng dẫn sử dụng; phiếu giao hàng/xuất kho hoặc phiếu xuất kho
                                kiêm vận
                                chuyển nội bộ; hóa đơn GTGT.</li>
                            <li>Bằng chi phí và trách nhiệm của mình, bên B chịu trách nhiệm đối với toàn bộ rủi ro về
                                thông tin
                                hàng hóa, về nội dung bản quyền, về thông tin pháp lý và bảo hành đối với hàng hóa của
                                mình.
                            </li>
                            <li><em>Đảm bảo giao đúng </em><em>h</em><em>àng </em><em>h</em><em>óa đã được niêm yết trên
                                ...
                                </em><em>h</em><em>óa bị lỗi</em>/khuyết điểm/không tuân thủ và chịu trách nhiệm phát
                                sinh
                            ...
                            <li>Tuân thủ và thực hiện đầy đủ các quy định được niêm yết công khai trên website. Bên B
                                nhận thức
                                được rằng: tất cả quy định được niêm yết trên website là công khai cho cả bên B và khách
                                hàng.
                                Bên B đồng ý với quy định này, không có bất kỳ khiếu nại và nghiêm chỉnh tuân thủ các
                                quy định
                                đó.</li>
                            <li>Trong mọi trường hợp, nếu bên B đã bán hết hàng hoặc không tiếp tục bán hàng đã đăng tải
                                trên
                                sàn giao dịch, thì bên B phải thông báo cho bên A ngay sau khi bên B bán hết hàng hoặc
                                quyết
                                định ngừng bán. Nếu bên B vi phạm quy định này thì bên A có quyền ngưng cung cấp dịch vụ
                                và đơn
                            ...
                            <li>Cung cấp thông tin có liên quan về sản phẩm theo yêu cầu của bên A, thông tin cung cấp
                                phải đầy
                                đủ chính xác, trung thực và hoàn toàn chịu trách nhiệm pháp luật về những thông tin đưa
                                ra.</li>
                            <li>Phải chịu toàn bộ trách nhiệm về tổn thất gây ra cho Khách Hàng nếu Khách Hàng chứng
                                minh được
                                lỗi do bên B gây ra; phải bồi thường cho Khách Hàng chậm nhất là một (01) ngày sau ngày
                                Khách
                            ...
                            <li>Chịu trách nhiệm trước pháp luật và giải trình với các cơ quan có thẩm quyền về chất
                                lượng, tính
                                hợp pháp của các sản phẩm/ dịch vụ do bên B cung cấp cũng như khiếu nại về sản phẩm/dịch
                                vụ của
                                khách hàng hoặc bên thứ ba.</li>
                            <li>Không được chiết khấu hoa hồng riêng cho nhân viên bên A, không được thuê; yêu cầu;
                                khuyến khích
                                nhân viên của bên A bán hoặc giới thiệu quản bá sản phẩm/dịch vụ của bên B (dưới mọi
                                hình thức).
                                Nếu bên B vi phạm bên A có quyền đơn phương chấm dứt hợp đồng, đồng thời bên A có quyền
                                không
                        ...
                        <ul>
                            <li>Dịch vụ bán hàng chuyên nghiệp của bên A trên website <strong>Siêu thị Nhật Bản
                                ...
                                dịch,
                                giúp bên B có thể giới thiệu một cách trực quan thông qua trang quảng cáo sản phẩm
                                chuyên nghiệp
                        ...
                        <ul>
                            <li>Bên A sẽ giữ lại % hoa hồng/Tổng giá trị các đơn hàng (không bao gồm chi phí vận chuyển
                                và các
                                khoản phí khác nếu có), số tiền hàng còn lại (tiền thu hộ hay còn gọi là tiền COD) bên A
                                sẽ
                                chuyển khoản hoặc tiền mặt cho bên B vào ngày 15 và 30 mỗi tháng sau khi hai bên xác
                                nhận biên
                                bản đối soát bằng văn bản.</li>
                            <li>Vào trước ngày thanh toán từ 1 đến 2 ngày và tổng tiền làm đối soát phải trên 1 triệu
                                đồng (nếu
                                dưới sẽ chuyển sang đối soát vào đợt tiếp theo) bên B gửi biên bản đối soát tổng số
                                lượng hàng
                                hóa cho bên A để đối chiếu. Nếu có sự chênh lệch bản đối soát giữa hai bên, hai bên sẽ
                                tìm
                                nguyên nhân chênh lệch trong vòng một (01) ngày làm việc, nếu không tìm được nguyên nhân
                                thì bản
                                đối soát của bên A được sử dụng là kết quả cuối cùng để hai Bên thanh toán Tiền Hàng và
                                phí xử
                        ...
                        <ul>
                            <li>Khi giao hàng, bên B có trách nhiệm chuẩn bị sẵn hàng hóa và các giấy tờ kèm theo để
                                ...
                                hàng/xuất kho hoặc phiếu xuất kho kiêm vận chuyển nội bộ; hóa đơn GTGT (nếu khách hàng
                                yêu cầu).
                            </li>
                            ...
                            <li>Phí vận chuyển gồm: cước phí vận chuyển, phí COD (phí giao hàng và trả tiền), phí chuyển
                                hoàn,
                                phí hàng cồng kềnh (nếu có). Bảng phí vận chuyển để tính phí vận chuyển theo từng đơn
                                đặt hàng
                        ...
                        <ul>
                            <li>Bên B gửi văn bản đề nghị bên A tạm ngừng một phần hoặc toàn bộ việc nêm yết bên B và
                                dịch vụ
                                nếu có, thời gian tạm ngừng tối đa là 30 ngày. Hết thời hạn, bên B phải thông báo khôi
                                phục lại
                                dịch vụ. Sau thời gian tạm ngừng bên B không khôi phục lại thì bên A hiểu là bên B từ
                                chối tiếp
                                tục thực hiện dịch vụ và Thỏa thuận này đã chấm dứt và không còn hiệu lực thi hành với
                                bên A.
                            </li>
                            ...
                            <li>Bên B vi phạm một trong các điều khoản thỏa thuận tại Thỏa thuận hoặc vi phạm quy định
                                sử dụng
                                trên website japana.vn hoặc theo quy định của cơ quan Nhà nước có thẩm quyền, hình thức
                                giải
                                quyết quyền lợi và nghĩa vụ trong trường hợp này như sau: Dịch vụ được bên A thực
                                hiện tiếp
                                sau khi bên B chấm dứt hành vi vi phạm, thời gian tạm ngừng vẫn được tính là thời
                                gian thực
                                hiện Thỏa thuận và bên B phải bồi thường thiệt hại (nếu có) cho bên A. Trong trường hợp
                                sau 10
                                ngày kể từ ngày vi phạm, bên B không chấm dứt hành vi vi phạm bên A có quyền đơn phương
                                chấm dứt
                                Thỏa thuận.</li>
                        ...
                        <p>Mọi tình huống xảy ra sau và trong khi Thỏa thuận có hiệu lực do các yếu tố không lường trước
                            và
                            không tránh được như: chiến tranh, các cuộc nổi loạn, bạo loạn, các hành động phá hoại, các
                            cuộc
                            đình công, bãi công, các đạo luật hay quy chế của Chính phủ thay đổi, cháy, nổ hay các tai
                            nạn không
                            thể tránh được khác, lũ lụt, bão, động đất hay các hiện tượng tự nhiên không bình thường
                            khác,
                            hacker, lỗi kỹ thuật ngoài sự kiểm soát của các Bên trong Thỏa thuận và ảnh hưởng trực tiếp
                            đến việc
                        ...
                        <p>Hai bên cam kết mọi thông tin, tài liệu liên quan đến Bên kia sẽ được bảo mật tuyệt đối,
                            không tiết
                            lộ cho bất kỳ bên thứ ba ngoại trừ các bên như tòa án, viện kiểm sát, cảnh sát, công an,
                            quản lý thị
                            trường, cơ quan thuế, văn phòng luật sư, trung tâm bảo vệ người tiêu dùng, các cơ quan quản
                            lý nhà
                            nước khác, hoặc công ty làm về bảo mật yêu cầu cung cấp thông tin theo các quy định của pháp
                            luật
                            Việt Nam, các bên có quyền cung cấp thông tin theo yêu cầu với mục đích bảo vệ quyền lợi,
                            thương
                        ...
                        <p>Mọi mâu thuẫn, tranh chấp phát sinh liên quan tới Thỏa thuận này, trước hết sẽ được hai bên
                            thống
                            nhất giải quyết bằng thương lượng, hòa giải. Trong trường hợp các bên không Thỏa thuận được
                            với nhau
                            thì&nbsp; trong vòng ba mươi (30) ngày kể từ ngày hai bên không đạt được hòa giải thì một
                            trong hai
                            bên có quyền đưa vụ việc ra Trung tâm trọng tài quốc tế Việt Nam (VIAC) để giải quyết theo
                            quy tắc
                            tố tụng của VIAC. Nơi giải quyết tranh chấp là nơi đặt trụ sở chính của japana.vn (bên A),
                            ngôn ngữ
                            là Tiếng Việt. Phán quyết của VIAC là phán quyết cuối cùng có giá trị ràng buộc các bên phải
                            thực
