                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li><a href="{{URL::to('/huong-dan-mua-hang')}}" title="Hướng dẫn mua hàng">Hướng dẫn
                                        mua
                                        hàng</a></li>
                                <li class="active"><a href="{{URL::to('/quyen-loi-vip')}}" title="Quyền lợi VIP">Quyền
                                        lợi VIP</a></li>
                ...
                <div class="static-detail">
                    ...
                    <div class="detail-static">
                        <p>Nhằm mang đến cho&nbsp;khách hàng thân thiết của Japana được mua hàng với&nbsp;những dịch vụ
                            tốt
                            nhất, chúng tôi đưa ra các Ưu Đãi&nbsp;tương ứng với cấp độ VIP&nbsp;như sau:</p>
