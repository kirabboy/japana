                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li><a href="{{URL::to('/phuong-thuc-thanh-toan')}}"
                                        ...
                                        thanh toán</a></li>
                                <li class="active"><a href="{{URL::to('/thoi-gian-giao-hang')}}"
                                        title="Thời gian giao hàng">Thời gian giao
                                        hàng</a></li>
                ...
                <div class="static-detail">
                    ...
                    <div class="detail-static">
                        <p style="text-align:justify">Thời gian giao hàng được tính bắt đầu kể từ khi Siêu Thị Nhật Bản
                            Japana&nbsp;xác nhận đơn hàng thành công. Quý khách có thể tham khảo tại bảng thời gian giao
                            hàng
                        ...
                        <h4 style="text-align:justify"><img alt="THỜI GIAN GIAO HÀNG"
                                ...
                                style="height:242px; width:800px">
                        </h4>

                        <h3 style="text-align:justify"><strong>Khi các sản phẩm của Japana đang ở Nhật Bản:</strong>
                        </h3>

                        <h4 style="text-align:justify"><img alt="THỜI GIAN GIAO HÀNG"
                                src="{{URL::to('public/images/mathangtainhatbang.jpeg')}}"
                                style="height:238px; width:800px">
                        </h4>

                        <h3 style="text-align: justify;"><strong>Vì sao các sản phẩm của&nbsp;Siêu Thị Nhật Bản
                                Japana&nbsp;đang
                                ở Nhật Bản?</strong></h3>

                        <p style="text-align:justify"><strong><a href="https://japana.vn"
                                    style="line-height: 20.8px;">Japana.vn</a></strong>&nbsp;là website bán hàng Nhật
                            Bản trực
                            tuyến, các sản phẩm được đăng tải trên website Japana do Văn Phòng đại diện của công
                            ty&nbsp;Japana
                            Việt nam tại Nhật Bản và/hoặc do các nhà cung cấp&nbsp;nhập khẩu trực tiếp từ Nhật
                            Bản&nbsp;về Việt
                            Nam. Tuy nhiên, vì là ngành hàng tiêu dùng có nhiều sản phẩm, nên có một số sản
                            phẩm&nbsp;theo quy
                            định hiện hành của Japana,&nbsp;sau khi Quý khách hàng đặt mua chúng tôi mới nhập về, vì vậy
                            thời
                            gian giao hàng lâu hơn hàng đã có tại Việt Nam khoản 10 ngày. Trong thời gian tới chúng tôi
                            sẽ cố
                            gắng khắc phục vấn đề này.</p>

                        <p style="text-align:justify">Các trường hợp sau đây nằm ngoài phạm vị cam kết của Japana về
                            việc không
                            giao hàng đúng hẹn:</p>

                        <ul>
                            <li style="text-align: justify;">Quý khách không cung cấp chính xác, đầy đủ địa chỉ giao
                                hàng và
                                thông tin liên lạc trong quá trình đặt hàng (phần "Thông tin Giao hàng").</li>
                            <li style="text-align: justify;"><strong>Siêu Thị Nhật Bản Japana</strong> nhiều lần liên hệ
                                quý
                                khách qua điện thoại, email nhưng không nhận được phản hồi</li>
                            <li style="text-align: justify;">Thời gian giao đến địa chỉ giao hàng đã được ấn định trước
                                với quý
                                khách nhưng quý khách không sẵn sàng để nhận hàng.</li>
                            <li style="text-align: justify;"><strong>Siêu Thị Nhật Bản Japana</strong>&nbsp;đã giao hàng
                                đúng
                                hẹn theo "Thông tin Giao hàng" nhưng quý khách để nhân viên giao hàng&nbsp;chờ quá 10
                                phút để
                                nhận hàng và mọi nỗ lực của Japana nhằm liên hệ với quý khách đều không thành công.</li>
                            <li style="text-align: justify;">Những trường hợp bất khả kháng như thiên tai (bao gồm động
                                đất, gió
                                xoáy, tai nạn giao thông,...), hoặc trường hợp gián đoạn mạng lưới giao thông trên quy
                                mô toàn
                                quốc hay quy mô địa phương và những trục trặc cơ học xảy ra cho các phương tiện vận
                                chuyển hay
                                máy móc.</li>
                        </ul>
                    </div>
