...
//Route - Tài Khoản
Route::get('/tai-khoan/register', [UserController::class, 'showPage'])->name('auth.show');
Route::post('/tai-khoan/register', [UserController::class, 'store'])->name('auth.register');
Route::get('/tai-khoan/login', [UserController::class, 'showLogin'])->name('auth.showlogin');
Route::post('/tai-khoan/login', [UserController::class, 'login'])->name('auth.login');
